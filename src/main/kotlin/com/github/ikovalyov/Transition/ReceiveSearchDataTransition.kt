...
class ReceiveSearchDataTransition: TransitionAbstract<SearchDataReceived>(
    ...
    private fun checkIfClassesCanBeHandled(stateFrom: RequestValidated<*>): Boolean {
        ...
        return stateFrom.previousState is SearchRequestReceived
    }

    override fun performTransition(stateFrom: AutomataStateInterface): SearchDataReceived {
        ...
        return SearchDataReceived(
                "search results",
                stateFrom as RequestValidated<SearchRequestReceived>
        )
    }
}
